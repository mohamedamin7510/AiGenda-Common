...
namespace AI_genda_API.Migrations
{
    ...
    [Migration("20260324064456_Intalize the database and set the all relation")]
    partial class Intalizethedatabaseandsettheallrelation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AI_genda_API.Entities.ExtendedUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEOW4qUXUJTPHFkTAiPBWaqlphfM7AYfQhjEJjrzIta4wvGPbgjBTagjg+kFzZUWAww==",
