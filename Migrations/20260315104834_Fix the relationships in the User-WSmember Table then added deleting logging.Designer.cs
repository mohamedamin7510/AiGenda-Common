...
namespace AI_genda_API.Migrations
{
    ...
    [Migration("20260315104834_Fix the relationships in the User-WSmember Table then added deleting logging")]
    partial class FixtherelationshipsintheUserWSmemberTablethenaddeddeletinglogging
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AI_genda_API.Entities.Space", b =>
                {
                    ...
                    b.HasOne("AI_genda_API.Entities.ExtendedUser", "RemovedBy")
                        .WithMany()
