...
namespace AI_genda_API.Migrations
{
    ...
    [Migration("20260417140526_Updated tables on moster ASP")]
    partial class UpdatedtablesonmosterASP
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AI_genda_API.Entities.ExtendedUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEGHSHxdvbU56b6B699SWf2r7D22u6e74j1n9b5zB0S7e+lf7+mPIM01v6rgWJIUhWQ==",
