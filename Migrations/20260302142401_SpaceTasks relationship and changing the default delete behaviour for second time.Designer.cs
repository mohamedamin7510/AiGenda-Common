...
namespace AI_genda_API.Migrations
{
    ...
    [Migration("20260302142401_SpaceTasks relationship and changing the default delete behaviour for second time")]
    partial class SpaceTasksrelationshipandchangingthedefaultdeletebehaviourforsecondtime
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AI_genda_API.Entities.WorkSpace", b =>
                {
                    ...
                    b.Property<string>("WorkspaceUsersUserID")
                        .HasColumnType("nvarchar(450)");

                    b.Property<int?>("WorkspaceUsersWrokSpaceID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("WorkspaceUsersWrokSpaceID", "WorkspaceUsersUserID");

                    b.ToTable("WorkSpaces");
                });

            modelBuilder.Entity("AI_genda_API.Entities.WorkspaceUsers", b =>
                {
            ...
            modelBuilder.Entity("AI_genda_API.Entities.WorkSpace", b =>
                {
                    ...
                    b.HasOne("AI_genda_API.Entities.WorkspaceUsers", null)
                        .WithMany("WorkSpaces")
                        .HasForeignKey("WorkspaceUsersWrokSpaceID", "WorkspaceUsersUserID");
